...
import randomForest_NoGlobal_d2 as modelfncs
...
# Save the figure
tmp_image = os.path.join(tmp_image_direct, "learning_curve_NoGlobal.png")
...
# Save and show
feature_imp_file = os.path.join(tmp_image_direct, "feature_importance_dualaxis.png")
