...
# Save the figure
tmp_image = os.path.join(tmp_image_direct, "learning_curve_PeakFocused.png")
...
# Save and show
feature_imp_file = os.path.join(tmp_image_direct, "feature_importance_PeakFocused_aligned.png")
